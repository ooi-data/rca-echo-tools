...
@click.option(
    ...
    type=str,
    default=DATA_BUCKET,
    help="S3 bucket to write zarr store to",
)
@click.option(
    "--run-type",
    required=False,
...
@click.option(
    ...
    default=False,
    show_default=True,
    help="Flag to indicate if harvest should run on RCA cloud.",
)
...
@click.option(
    ...
    type=str,
    default="4s",
    help="Time bin size for ping_time dimension default is 4s",
)
@click.option(
    "--range-bin",
    required=False,
    type=str,
    default="0.1m",
    help="Range bin size for range dimension, default is 0.1m",
)
@click.option(
    "--parallel-in-cloud",
    type=bool,
    default=False,
    show_default=True,
    help="run prefect deployment in parellel in cloud, parallelized by date",
)
@click.option(
    "--s3-sync",
    type=bool,
    default=False,
    show_default=True,
    help="Whether to sync resulting echogram PNGs to s3.",
)
